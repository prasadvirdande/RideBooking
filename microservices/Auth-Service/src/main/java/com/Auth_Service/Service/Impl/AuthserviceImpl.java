...
//
//        UserDto user =
//                userClient.createUser(authRequest);
//
//         if(user.equals(null)){
...
//            user = driverClient.getDriverByEmail(
//                    request.getEmail()
//            );
//        } else {
...
//
//    @Override
//    public AuthResponse Driverregister(DriverRequest authRequest) {
//        authRequest.setPassword(
//                passwordEncoder.encode(
//                        authRequest.getPassword()
//                )
//        );
//
//       UserDto user = driverClient.createDriver(authRequest);
//
//        if(user.equals(null)){
//            throw new NullPointerException("User is null");
//        }
